...
export const MOCK_SERVICES: Service[] = [
  { id: "s1", name: "Work Permit", code: "SVC-WP", category: "Work Permit", unitPrice: 5_000_000, processingDays: 30, status: "active", createdAt: "2026-01-10", customFields: { requiredDocs: "Passport, Labor contract, Health check" } },
  { id: "s2", name: "Visa Processing", code: "SVC-VISA", category: "Visa", unitPrice: 3_000_000, processingDays: 15, status: "active", createdAt: "2026-02-01", customFields: {} },
  { id: "s3", name: "Business License", code: "SVC-BL", category: "License", unitPrice: 8_000_000, processingDays: 45, status: "active", createdAt: "2026-03-12", customFields: {} },
  { id: "s4", name: "TRC Application", code: "SVC-TRC", category: "Work Permit", unitPrice: 4_000_000, processingDays: 20, status: "active", createdAt: "2026-04-05", customFields: {} },
  { id: "s5", name: "Company Registration", code: "SVC-CR", category: "License", unitPrice: 12_000_000, processingDays: 60, status: "inactive", createdAt: "2026-05-20", customFields: {} },
];
